...
$ git clone https://github.com/architect-community/hello-world.git
$ git clone https://github.com/architect-community/stateless-component.git
$ cd ./stateless-component
